...
class OrdenesController
{
    ...
    private $qbultos, $qsobres, $peso, $dimensiones, $comuna, $direcccion, $referencia, $rutrmtt, $nombrermtt, $tel1rmtt, $tel2rmtt, $rutdtno, $nombredtno, $tel1dtno, $tel2dtno, $username, $oficina, $valordeclarado, $tipodocumento, $ndoc, $tipopago;
