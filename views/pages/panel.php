...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Tu Paquete Expres</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Carlos Gaete</a>
        </div>
      </div>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-6">
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Titulo de carta</h5>

                <p class="card-text">
                  Un texto de ejemplo rápido para construir sobre el título de la tarjeta y componer la mayor parte de la tarjeta.
                  contenido.
                </p>

                <a href="#" class="card-link">Enlace de carta</a>
          ...
          <div class="col-lg-6">
            <div class="card">
              <div class="card-header">
                <h5 class="m-0">Presentado(a)</h5>
              </div>
              <div class="card-body">
                <h6 class="card-title">Tratamiento especial del título</h6>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Derechos de autor &copy; 2014-2021 <a href="https://adminlte.io">AdminLTE.io</a>.</strong> Reservados todos los derechos.
  </footer>
</div>
<!-- ./wrapper -->
