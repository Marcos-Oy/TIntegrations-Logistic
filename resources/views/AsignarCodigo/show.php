...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="h1 text-center text-primary">Asignacion de Codigos</div>
            ...
            //print_r($orden)."<br>";
            ?>
            <a href="asignarCodigo.php" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Volver</a>
            <?php     exit;}  ?>
        ...
        <div class="row">
            ...
            <div class="col">
                <div class="form-check">
                    <input class="form-check-input" type="radio" value="En tránsito" name="accion" id="accion1">
                    <label class="form-check-label" for="accion1">
                        En tránsito
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" value="En reparto" name="accion" id="accion2">
